-- Migration 083: Add Multi-Tenant Isolation (user_id and org_id) to Credentials Table
-- Enforces Bring-Your-Own-Key (BYOK) isolation across all provider credentials
...
-- 4. Update PostgreSQL Row Level Security (RLS) Policy for Credentials
